...
ActiveRecord::Schema.define(version: 20160518160859) do
  ...
  add_index "arifacts", ["project_id"], name: "index_arifacts_on_project_id", using: :btree
  ...
  add_foreign_key "arifacts", "projects"
